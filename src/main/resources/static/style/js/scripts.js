...
// Most compatible way to match heights.
// CSS using flexbox, etc. does not work well on IE.
...
/*function mr_parallax() {
    ...
    function b() {
        E = void 0 == window.mr_variant ? !1 : !0, E && (C = jQuery(".viu").get(0), void 0 != C && (C.scrollBy = function (a, b) {
            this.scrollTop += b
    ...
    function c() {
        var a = 0;
        return void 0 != C && (a = jQuery(C).find("nav:first").outerHeight(!0)), a
    }
    ...
    function f(a, b) {
        if (E) {
            if (b + n > a.elemTop && b < a.elemBottom)if (a.isFirstSection) {
        ...
        } else if (b + n > a.elemTop && b < a.elemBottom)if (a.isFirstSection) {
            var c = "translate3d(0, " + b / 2 + "px, 0)";
            a.imageHolder.style[m] = c
        } else {
    ...
    var j, k = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame, l = ["transform", "msTransform", "webkitTransform", "mozTransform", "oTransform"], m = a(l), n = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), o = 0, p = !1, q = !1, r = !0, s = 0, t = 0, u = 0, v = 0, w = 0, x = 2, y = 4, z = 300, A = 1, B = 30, w = 0, C = window, D = this, E = void 0 == window.mr_variant ? !1 : !0;
    jQuery(document).ready(function () {
        "use strict";
        n = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent || navigator.vendor || window.opera) ? jQuery(".parallax").removeClass("parallax") : k && (window.mr_parallax.profileParallaxElements(), b())
        ...
        j = [], o = c(), selector = ".parallax > .background-image-holder, .parallax ul.slides > li > .background-image-holder", E && (selector = ".viu .parallax > .background-image-holder, .viu .parallax ul.slides > li > .background-image-holder"), jQuery(selector).each(function (a) {
            var b = jQuery(this).closest(".parallax"), c = E ? b.position().top : b.offset().top;
            j.push({
                section: b.get(0),
                outerHeight: b.outerHeight(),
                elemTop: c,
                elemBottom: c + b.outerHeight(),
                isFirstSection: b.is(":first-of-type") ? !0 : !1,
                imageHolder: jQuery(this).get(0)
            }), E ? E && (b.is(":first-of-type") ? D.mr_setTranslate3DTransform(jQuery(this).get(0), 0 == g() ? 0 : g() / 2) : D.mr_setTranslate3DTransform(jQuery(this).get(0), (g() - c - o) / 2)) : b.is(":first-of-type") ? D.mr_setTranslate3DTransform(jQuery(this).get(0), 0 == g() ? 0 : g() / 2) : D.mr_setTranslate3DTransform(jQuery(this).get(0), (g() + n - c - o) / 2)
        })
...
window.mr_parallax = new mr_parallax, function (a, b) {
    function c(b, c, g, h) {
        b[d](f + c, "wheel" == e ? g : function (b) {
            !b && (b = a.event);
            var c = {
                originalEvent: b, target: b.target || b.srcElement, type: "wheel", deltaMode: "MozMousePixelScroll" == b.type ? 0 : 1, deltaX: 0, deltaZ: 0, notRealWheel: 1, preventDefault: function () {
...
jQuery(document).ready(function () {
    ...
    // Show Modal Button
    jQuery('#menu-item-651 a, a.capture-essence-section__request-a-sample-button').click(function (e) {
        jQuery('#requestModalButton').click();
        e.preventDefault();
    });
